...
from ezq_core.database import raw_exec
...
async def update_account(params, *args, **kwargs):
    ...
    if 'email' in d:
        u['email'] = d['email']
    await _set_columns_by_pkid('ezq_account', account_id, u)
